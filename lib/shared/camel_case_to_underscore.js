...
exports = module.exports = dependency.register(camelCaseToUnderscore);


function camelCaseToUnderscore (name) {

	return name.replace(/([^A-Z]?)([A-Z]+)/g, camelCaseToUnderscore.delimitWithUnderscores).toLowerCase();
