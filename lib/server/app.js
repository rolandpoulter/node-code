...
function App (
	...
	if (AppSessionManager) this.AppSessionManager = AppSessionManager;

	if (NedbSessionStore) this.NedbSessionStore = NedbSessionStore;
...
App.prototype.AppSessionManager = require('./app_session_manager');

App.prototype.NedbSessionStore = require('./nedb_session_store');
