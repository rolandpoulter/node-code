...
function AppSession (
  ...
  this.io_socket.sockets.on('connection', this.attachSocketSession.bind(this));
...
AppSession.prototype.attachSocketSession = function (socket) {
...
AppSession.prototype.configureSocketAuthorizer = function () {
	...
	this.io_socket.set('authorization', this.socketAuthorizer.bind(this));
