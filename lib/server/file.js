...
function File (project_location, project_name, absolute_path, project, cachedEntity, fs, path) {
...
File.prototype.publish = function (socket, method, args) {
	...
	var publisher = this.project.getPublisherFactory('file').createPublisher(this, socket);
