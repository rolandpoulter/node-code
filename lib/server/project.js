...
Project.load_session = function (app, session, callback) {
	...
	if (!session.projects) {
		...
		new Project(app.dir, '', session.projects, {}, app.socket_io.publishers);
	}
...
function Project (
	...
	project.directory = new this.Directory(project_location, this.relative_path, this.absolute_path, this.publishers);
...
Project.prototype.getDirectory = function (relative_directory_path) {
	...
	return new this.Directory(this.absolute_path, this.relative_path, relative_directory_path, this.publishers);

};

Project.prototype.getFile = function (relative_file_path) {

	return new this.File(this.absolute_path, this.relative_path, relative_file_path, this.publishers.file);
