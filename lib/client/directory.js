...
Directory.prototype.DirectoryUI = require('./ui/directory_ui');
...
Directory.prototype.publish = function (method, args) {
	...
	var DirectoryPublisher = require('./directory_publisher');

	var publisher = new DirectoryPublisher(this, this.directory_publisher.socket);
