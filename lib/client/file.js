...
function File (socket, project, directory, file_info, app_ui, Entity, FileUI, File) {
	...
	if (!file.ui) file.ui = new this.FileUI(file);
...
File.prototype.FileUI = require('./ui/file_ui');
...
File.prototype.publish = function (method, args) {
	...
	var publisher = this.socket.createEntityPublisher('File', this);
