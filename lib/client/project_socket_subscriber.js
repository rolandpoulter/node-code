...
function ProjectSocketSubscriber (events, socket, publisher, app_ui, Project, objectForEach) {
...
ProjectSocketSubscriber.prototype.createProject = function (project_data, project_name) {
	...
	new this.Project(project_name, project_data, this.events, this.publisher, this.app_ui);
