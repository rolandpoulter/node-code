...
function ProjectSocketSubscriber (socket, publishers, app_ui, Project, objectForEach) {
	...
	this.socket.on('client', this.onProjectsList.bind(this));
...
ProjectSocketSubscriber.prototype.objectForEach = require('../shared/object_for_each');


ProjectSocketSubscriber.prototype.onProjectsList = function (method, projects_map) {

	console.log(method, projects_map);
