...
function FileSubscriber (messenger, entity_cache, EntitySubscriber) {

	this.messenger = messenger;


	new EntitySubscriber(this, 'file', this.messenger, entity_cache, EntitySubscriber.getFileEntity);
