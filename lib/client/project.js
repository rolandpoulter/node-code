...
Project.prototype.createDirectory = function () {
	...
	this.directory.is_opened = true;
	this.directory.ui.shelf_item.dom_node.classList.remove('collapse');
	this.publishers.directory.emitOpenDirectory(this.name, this.directory.info.relative_path);
	this.publishers.directory.emitIndexDirectory(this.name, this.directory.info.relative_path);
